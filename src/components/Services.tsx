...
const services = [
  ...
  {
    title: "PG Meals",
    description: "Daily comfort and nutrition for paying guests staying away from home.",
    icon: <GraduationCap className="text-gold" />,
  },
  {
    title: "Gathering Meals",
    description: "Tailored menus for gatherings, parties and memorable corporate events.",
