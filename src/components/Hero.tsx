      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="flex-1 max-w-2xl">
          ...
          <div className="flex flex-wrap gap-4">
            <Link
              href="#services"
              className="bg-gold text-white px-8 py-3 rounded-sm font-medium hover:bg-gold/90 transition-all shadow-md"
            >
            ...
            <Link
              href="/corporate"
              className="border border-navy/20 text-navy px-8 py-3 rounded-sm font-medium hover:bg-navy/5 transition-all"
            >
              Corporate Enquiry
            </Link>
          </div>
        ...
        <div className="flex-1 relative">
          <div className="relative rounded-[40px] overflow-hidden shadow-2xl">
            ...
            <div className="relative w-full aspect-[4/3]">
              <Image
                src="/hero-food.jpg"
                alt="Gharana Meals homemade food"
                fill
                priority
                quality={85}
